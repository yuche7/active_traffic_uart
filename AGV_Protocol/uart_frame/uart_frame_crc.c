/**
 * @file uart_frame_crc.c
 * @brief UART帧CRC16校验实现
 * @details CRC16-CCITT查表法实现,高效稳定
 *
...
/**
 * @brief CRC16-CCITT查找表(多项式0x1021)
 * @note 预计算256个字节的CRC值,加速运算
 */
...
bool uart_frame_crc16_verify(const uint8_t* data, size_t length, uint16_t expected_crc)
{
    ...
    uint16_t calculated_crc = uart_frame_crc16_calculate(data, length);
